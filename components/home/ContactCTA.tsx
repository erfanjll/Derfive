  ...
  return (
    <section className="relative overflow-hidden border-t border-line py-32 md:py-48" aria-labelledby="home-contact">
      ...
      <div className="wrap relative text-center">
        <p className="label-mono mb-8"><span className="text-signal">05</span> — {t(dict.contact.label)}</p>
        <TextReveal as="h2" text={t(dict.contact.title)} className="font-display text-[clamp(3rem,10vw,9.5rem)] font-extrabold leading-[0.9] tracking-[-0.045em] text-bone" />
        <span id="home-contact" className="sr-only">{t(dict.contact.label)}</span>
